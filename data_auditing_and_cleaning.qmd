...
#### DOUBTS
  ...
  - Lots of `state_province` and `GADM_level_1` to correct. Is GADM_1 in English?
    ...
    'Südtirols' = 'Bolzano' (state_name in German?)
    'Centre-Val De Loire' = 'Centre' (something missing?)
    'Corsica' = 'Corse'  (something missing?)
    'Flanders' = 'Vlaanderen' (English?)
    'Opole Voivodeship' = 'Opole'  (something missing?)
